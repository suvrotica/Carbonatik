	...
	<div class="mx-auto max-w-screen-md px-4 py-8 lg:py-16">
		...
		<form action="#" class="space-y-8">
			...
			<div class="sm:col-span-2">
				<label
					for="message"
					class="mb-2 block text-sm font-medium text-neutral-900 dark:text-neutral-400"
					>Your message</label
				>
				<textarea
					id="message"
			...
			<button
				type="submit"
				class="rounded-lg bg-neutral-700 px-5 py-3 text-center text-sm font-medium text-white hover:bg-neutral-800 focus:outline-none focus:ring-4 focus:ring-neutral-300 sm:w-fit dark:bg-neutral-600 dark:hover:bg-neutral-700 dark:focus:ring-neutral-800"
				>Send message</button
			>
		</form>
	</div>
