<section class="bg-white dark:bg-neutral-900">
	<div class="mx-auto grid max-w-screen-xl px-4 py-8 lg:grid-cols-12 lg:gap-8 lg:py-16 xl:gap-0">
		<div class="mr-auto place-self-center lg:col-span-7">
			...
			>
				Discover our curated collection of luxury hotels, each a unique blend of comfort and
		...
		<div class="hidden lg:col-span-5 lg:mt-0 lg:flex">
			<img
				src="https://wqz50k0spm0gyalr.public.blob.vercel-storage.com/f1f92385-80d6-4f65-91c8-79f3275d2d2a-wDlut3k2kmJcgf3aoyY4noLtod4fHZ.webp"
