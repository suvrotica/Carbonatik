...
>
	...
	>
		<img
			class="w-2/3 dark:hidden"
			src="https://wqz50k0spm0gyalr.public.blob.vercel-storage.com/IMG-20240113-WA0002-removebg-preview-hbBGxWmoqCqBkCzwrZeFhCFoXlE3qf.png"
			alt="BFJK real estate"
		/>
		<img
			class="hidden w-2/3 dark:block"
			src="https://wqz50k0spm0gyalr.public.blob.vercel-storage.com/IMG-20240113-WA0002-removebg-preview-hbBGxWmoqCqBkCzwrZeFhCFoXlE3qf.png"
		...
		<div class="mt-4 md:mt-0">
			...
			<p class="mb-6 font-light text-gray-500 md:text-lg dark:text-gray-400">
				At BFJK Corp, we redefine luxury real estate. Our portfolio spans majestic hotel chains in
				the heart of America’s bustling cities and serene international locales. Our vision is to be
