<section class="bg-white dark:bg-neutral-900">
	<div class="mx-auto grid max-w-screen-xl px-4 py-8 lg:grid-cols-12 lg:gap-8 lg:py-16 xl:gap-0">
		<div class="mr-auto place-self-center lg:col-span-7">
			...
			>
				Discover Your Dream Property with BFJK
			</h1>
			<p
				class="mb-6 max-w-2xl font-light text-gray-500 md:text-lg lg:mb-8 lg:text-xl dark:text-gray-400"
			>
				At BFJK, we blend cutting-edge technology with personalized service to offer you an
				unmatched real estate experience. Explore our diverse portfolio and find properties that
				resonate with your lifestyle and investment goals.
			</p>
			<a
				href="/contact"
		...
		<div class="hidden lg:col-span-5 lg:mt-0 lg:flex">
			<img
				src="https://wqz50k0spm0gyalr.public.blob.vercel-storage.com/f2-kxvzGHvUCZX4vPz3yrpSFda8Us1e2s.png"
